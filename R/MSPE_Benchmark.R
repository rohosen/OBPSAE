...
#'
#' This function computes the McSpline MSPE estimator of benchmarked OBP.
...
#' @return The function will return a list with the McSpline MSPE estimator of both adjusted and augmented OBP's.
...
#' @return The function will return a list with the McJack and McSpline (if returnMcSpline is TRUE) MSPE estimators of both adjusted and augmented methods.
#' @references Bandyopadhyay R, Jiang J (2017) "Benchmarking of Observed Best Predictor"
#' @references Jiang J, Nguyen T, and Rao J. S. (2011), "Best Predictive Small Area Estimation", Journal of the American Statistical Association.
#' @export
