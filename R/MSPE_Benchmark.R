...
#' Mc Spline MSPE benchmark estimator
#' 
#' This function computes the McSPline MSPE benchmark estimator.
...
#' @return The function will return a list with the McSpline benchmark MSPE estimator, both adjusted and augmented methods.
...
#' Mc Jack MSPE benchmark estimator
#' 
...
#' @return The function will return a list with the McJack and McSpline (if returnMcSpline is TRUE) MSPE benchmark estimators, both adjusted and augmented methods.
#' @references Bandyopadhyay R, Jiang J (2017) "Benchmarking of Observed Best Predictor"
#' @references Jiang J, Nguyen T, and Rao J. S. (2011), "Best Predictive Small Area Estimation", Journal of the American Statistical Association.
#' @export
